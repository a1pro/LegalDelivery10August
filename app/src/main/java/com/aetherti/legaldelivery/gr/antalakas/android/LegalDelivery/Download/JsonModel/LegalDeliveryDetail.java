...
public class LegalDeliveryDetail {

    public String $id;
    public String LegalDeliveryID;
    public String SERVERFNAME;
    public String SERVERLNAME;
    public String SERVERLNO;
    public String SERVERCOUNTY;
    public String SERVERSTATE;
    public String SERVERCITY;
    public String PPSERVED1;
    public String PPSERVED2;
    public String DESCRIPTION1;
    public String DESCRIPTION2;
    public String DESCRIPTION3;
    public String DESCRIPTION4;
    public String DATEOFMAILING;
    public String SERVICERESULTSINPUT;
    public String LTSERVED1;
    public String LTSERVED2;
    public String NOTARYDATE;
    public String LTADDLMAILS;
    public String LTM1ADDRESS;
    public String LTM1APT;
    public String LTM1CITY;
    public String LTM1FULLNAME;
    public String LTM1STATE;
    public String LTM1ZIP;
    public String LTM2ADDRESS;
    public String LTM2APT;
    public String LTM2CITY;
    public String LTM2FULLNAME;
    public String LTM2STATE;
    public String LTM2ZIP;
    public String LTM3ADDRESS;
    public String LTM3APT;
    public String LTM3CITY;
    public String LTM3FULLNAME;
    public String LTM3STATE;
    public String LTM3ZIP;
    public String LTM4ADDRESS;
    public String LTM4APT;
    public String LTM4CITY;
    public String LTM4FULLNAME;


    public String LTM4STATE;
    public String LTM4ZIP;
    public String LTM5ADDRESS;
    public String LTM5APT;
    public String LTM5CITY;
    public String LTM5FULLNAME;
    public String LTM5STATE;
    public String LTM5ZIP;
    public String LTM6ADDRESS;
    public String LTM6APT;
    public String LTM6CITY;
    public String LTM6FULLNAME;
    public String LTM6STATE;
    public String LTM6ZIP;
    public String LTM7ADDRESS;
    public String LTM7APT;
    public String LTM7CITY;
    public String LTM7FULLNAME;
    public String LTM7STATE;
    public String LTM7ZIP;
    public String LTM8ADDRESS;


    public String LTM8APT;
    public String LTM8CITY;
    public String LTM8FULLNAME;
    public String LTM8STATE;
    public String LTM8ZIP;
    public String LTM9ADDRESS;
    public String LTM9APT;
    public String LTM9CITY;
    public String LTM9FULLNAME;
    public String LTM9STATE;
    public String LTM9ZIP;
    public String LTM10ADDRESS;
    public String LTM10APT;
    public String LTM10CITY;
    public String LTM10FULLNAME;
    public String LTM10STATE;
    public String LTM10ZIP;
    ...
    public void setSERVICERESULTSINPUT(String sERVICERESULTSINPUT) {
        SERVICERESULTSINPUT = sERVICERESULTSINPUT;
    }
